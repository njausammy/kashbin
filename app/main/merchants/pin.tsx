...
const PinEntry = () => {
    ...
    const handleVerifyPIN = async () => {
        if (pin === TEMP_CORRECT_PIN) {
            ...
            router.push({
                pathname: '/main/merchants/processing',
                params: params
            });
        } else {
        ...
        <VStack backgroundColor="$white" flex={1}>
            ...
            <VStack flex={1} paddingHorizontal={24} paddingTop={40} justifyContent="space-between">
                <VStack alignItems="center">
                    ...
                    <Text fontSize={18} fontWeight="600" color={Colors.dark} marginBottom={32}>
                    ...
                    {/* Error Message */}
                    {error ? (
                        <Text fontSize={14} color={Colors.error} marginBottom={16}>
                            {error}
                        </Text>
                    ) : null}
