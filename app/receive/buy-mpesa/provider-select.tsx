...
const ProviderSelect = () => {
    ...
    const handleContinue = () => {
        if (selectedProvider) {
            router.push({
                pathname: '/receive/buy-mpesa/payment-instructions',
                params: {
                    ...params,
                ...
                <VStack paddingHorizontal={24} paddingTop={24} paddingBottom={120}>
                    ...
                    >
                        <HStack justifyContent="space-between" marginBottom={8}>
                            <Text fontSize={14} color="#8E8E93">You're buying</Text>
                            <Text fontSize={16} fontWeight="700" color={Colors.primary.DEFAULT}>
                                {params.usdtAmount} USDT
                            </Text>
                        </HStack>
                        <HStack justifyContent="space-between">
                            <Text fontSize={14} color="#8E8E93">You'll pay</Text>
                            <Text fontSize={16} fontWeight="600" color="#1C1C1E">
                                KES {parseFloat(params.kesAmount).toLocaleString('en-KE')}
                            </Text>
                        </HStack>
                    </Box>
