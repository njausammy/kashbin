    ...
    const selectionOptions: SelectionOption[] = [
        {
            ...
            icon: 'qr-code',
            route: '/receive/buy-cash/scan-qr',
            iconBg: '#1E40AF'
        },
        {
            ...
            icon: 'keypad',
            route: '/receive/buy-cash/enter-code',
        ...
        },
        {
            ...
            icon: 'list',
            route: '/receive/buy-cash/agent-list',
            iconBg: '#8B5CF6'
        }
    ];
                ...
                <VStack paddingHorizontal={24} paddingTop={32} paddingBottom={32} space="lg">
                    ...
                    >
                        <HStack space="sm" alignItems="flex-start">
                            ...
                            <VStack flex={1}>
                                <Text fontSize={14} fontWeight="600" color="#065F46" marginBottom={4}>
                                    How Buy with Cash Works
                                </Text>
                                <Text fontSize={13} color="#065F46">
                                    1. Select an agent near you{'\n'}
                                    2. Enter amount of USDT to buy{'\n'}
                                    3. Receive a deposit code{'\n'}
                                    4. Visit agent with cash & code{'\n'}
                                    5. Agent releases USDT to your wallet
                                </Text>
                            </VStack>
                        </HStack>
                    </Box>
