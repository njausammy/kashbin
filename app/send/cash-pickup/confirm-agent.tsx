...
const ConfirmAgent = () => {
    ...
    const handleContinue = () => {
        router.push({
            pathname: '/send/cash-pickup/amount',
            params: {
                    ...
                    >
                        ...
                        >
                            <HStack space="sm" alignItems="center">
                                ...
                                <Text fontSize={14} color={Colors.grey}>Withdrawal Fee</Text>
                            </HStack>
                            <Text fontSize={14} fontWeight="600" color={Colors.dark}>
                                {params.agentFee}%
                            </Text>
                        ...
                        <HStack
                            ...
                            alignItems="center"
                            padding={16}
                            backgroundColor={isOpen ? '#22C55E15' : '#DC262615'}
                        >
                            <HStack space="sm" alignItems="center">
                                <Ionicons
                                    name={isOpen ? 'checkmark-circle' : 'close-circle'}
                                    size={20}
                                    color={isOpen ? '#22C55E' : '#DC2626'}
                                />
                        ...
                        <HStack space="sm" alignItems="flex-start">
                            ...
                            <VStack flex={1}>
                                ...
                                <Text fontSize={13} color="#1E3A8A">
                                    After confirming, you'll enter the amount to withdraw and receive a pickup code to show at this agent's location.
                                </Text>
                            </VStack>
                        </HStack>
                    </Box>
                        ...
                        >
                            <HStack space="sm" alignItems="flex-start">
                                ...
                                <Text fontSize={13} color="#92400E" flex={1}>
                                    This agent is currently closed. You can still proceed, but you'll need to visit during operating hours to collect your cash.
                                </Text>
                            </HStack>
                        </Box>
                    )}
