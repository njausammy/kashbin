...
const AgentList = () => {
    ...
    const getSortedAgents = (): Agent[] => {
        switch (sortBy) {
            ...
            case 'fee':
                return sortAgentsByFee(allAgents, 'cashOut');
            default:
                return allAgents;
        }
    };
    ...
    return (
        <VStack backgroundColor="$white" flex={1}>
            {/* Header */}
            <Box backgroundColor="#10B981" paddingTop={50} paddingBottom={24}>
            ...
            <ScrollView>
                <VStack paddingHorizontal={24} paddingTop={24} paddingBottom={32}>
                    ...
                    <HStack space="sm" marginBottom={24}>
                        ...
                        >
                            <Box
                                backgroundColor={sortBy === 'distance' ? '#10B981' : '#F9FAFB'}
                                borderRadius={8}
                                padding={12}
                                alignItems="center"
                                borderWidth={1}
                                borderColor={sortBy === 'distance' ? '#10B981' : '#E5E7EB'}
                            >
                                <Text
                                    fontSize={13}
                                    fontWeight="600"
                                    color={sortBy === 'distance' ? '$white' : '#8E8E93'}
                                >
                                    Nearest
                                </Text>
                            </Box>
                        ...
                        >
                            <Box
                                backgroundColor={sortBy === 'rating' ? '#10B981' : '#F9FAFB'}
                                borderRadius={8}
                                padding={12}
                                alignItems="center"
                                borderWidth={1}
                                borderColor={sortBy === 'rating' ? '#10B981' : '#E5E7EB'}
                            >
                                <Text
                                    fontSize={13}
                                    fontWeight="600"
                                    color={sortBy === 'rating' ? '$white' : '#8E8E93'}
                                >
                                    Top Rated
                                </Text>
                            </Box>
                        ...
                        >
                            <Box
                                backgroundColor={sortBy === 'fee' ? '#10B981' : '#F9FAFB'}
                                borderRadius={8}
                                padding={12}
                                alignItems="center"
                                borderWidth={1}
                                borderColor={sortBy === 'fee' ? '#10B981' : '#E5E7EB'}
                            >
                                <Text
                                    fontSize={13}
                                    fontWeight="600"
                                    color={sortBy === 'fee' ? '$white' : '#8E8E93'}
                                >
                                    Lowest Fee
                                </Text>
                            </Box>
                            ...
                            >
                                ...
                                >
                                    <HStack space="md" alignItems="flex-start">
                                        ...
                                        >
                                            <Ionicons
                                                name={agent.type === 'otc' ? 'business' : 'storefront'}
                                                size={24}
                                                color="#10B981"
                                            />
                                        </Box>
                                            ...
                                            <HStack space="lg" alignItems="center">
                                                ...
                                                <HStack space="xs" alignItems="center">
                                                    ...
                                                    <Text fontSize={13} color={Colors.grey}>
                                                        Fee: {(agent.fees.cashOut * 100).toFixed(1)}%
                                                    </Text>
                                                </HStack>
                                            </HStack>
                    ...
                    <Pressable marginTop={24}>
                        ...
                        >
                            <HStack space="sm" alignItems="center">
                                ...
                                <Text fontSize={15} fontWeight="600" color="#10B981">
