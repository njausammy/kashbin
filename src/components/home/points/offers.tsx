...
const OffersScreen = () => {
    ...
    const offers: IOffer[] = [
        { image: require('../../../../assets/images/points-4.png'), name: 'Car Wash', price: 4000, status: 'Redeem', timeLeft: 'in 4hrs 45min' },
        { image: require('../../../../assets/images/points-1.png'), name: 'Monthly shopping bundle', price: 2300, status: 'Redeemed', timeLeft: 'in 1hr 27min' },
        { image: require('../../../../assets/images/points-2.png'), name: 'HeHa Cooking Oil 3L', price: 2500, status: 'Completed', timeLeft: 'in 10min' },
        { image: require('../../../../assets/images/points-3.png'), name: 'Ndovu maize Flour 2Kg pack x 2', price: 1500, status: 'Redeem', timeLeft: 'in 13hrs 45min' },
    ];
        ...
        <Card marginBottom={10} borderBottomWidth={1} borderBottomColor="#E8E8E8" height={86} paddingVertical={15} flexDirection="row" justifyContent="space-between" alignItems="center">
            <HStack alignItems="center">
                ...
                <VStack marginLeft={10}>
                    <Text color='#414141' fontSize={14} fontWeight={400}>{offer.name}</Text>
                    <Text color='#888888' fontSize={12}>KES {offer.price}</Text>
                    <Text color='#888888' fontSize={12}>Offer ends {offer.timeLeft}</Text>
                </VStack>
            </HStack>

            <Button
                borderRadius={20}
                backgroundColor={offer.status === 'Completed' ? '#bcbcbc' : (offer.status === "Redeem" ? "#DB1E36" : "#43A048")}
